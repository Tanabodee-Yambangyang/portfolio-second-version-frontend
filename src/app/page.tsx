...
import LoadingComponent from "@/components/status-components/LoadingComponent";
...
import ErrorComponent from "@/components/status-components/ErrorComponent";
  ...
  return (
    <>
      {loading ? (
        ...
        <div className={
          clsx("grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen font-[family-name:var(--font-geist-sans)] transition",
            isDarkTheme
